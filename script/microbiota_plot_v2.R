...
###test
 outdir<-"/Users/yujijun/Documents/01-Work/06-BD_project/BD_projects/centrifuge/figure/v3.5/"
 clinic.col <- "Tissue"
 clinic_col <- "Tissue"
 input<-"/Users/yujijun/Documents/01-Work/06-BD_project/BD_projects/centrifuge/figure/v3.5/merged_microbiota_abundance.txt"
 meta<-"/Users/yujijun/Documents/01-Work/06-BD_project/BD_projects/centrifuge/figure/v3.5/metasheet.csv"
...
for (clinic_col in clinic.col){
  ...
  if(length(phenos) > 1){
    ...
    pheatmap(t(abun.ss), color = my_palette, breaks = bk,border_color = NA, show_colnames = T,
  ...
  for(clust_phe in phenos){
    ...
    pheatmap(t(ss.abun), color = my_palette, breaks = bk,border_color = NA, show_colnames = T, 
